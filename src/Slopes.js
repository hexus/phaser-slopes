...
export default class Slopes
{
	 ...
	 * Start the plugin.
	 *
	 * Overrides MatterJS functions to augment their behaviour.
	 */
	start() {
		...
		let Collision = Phaser.Physics.Matter.Matter.Collision;
		let World     = Phaser.Physics.Matter.World;

		console.log(World, Collision, Axes, Resolver);
		...
		this.overridden.collides = Collision.collides;
		...
		Collision.collides = Overrides.Matter.SAT.collides;
	...
	shutdown() {
		...
		Collision.collides = this.overridden.collides;
